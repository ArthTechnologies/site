export default {
  "en-US": {
    ...
    "main.footnote1": "A cada servidor se le asigna un núcleo, y no tiene acceso a los ocho núcleos del procesador, porque Minecraft solo puede utilizar un núcleo.",
