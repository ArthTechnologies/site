export default {
  "en-US": {
    ...
    "main.interface.desc":
      "Almost every hosting provider uses the same Pterodactyl® Interface. We felt we could do better, so we started the <a href='/software' class='text-accent hover:link'>Arth Panel</a> project, which reimagines the Minecraft Hosting experience.",
    "main.crossplay.title": "Play with friends on any edition.",
    "main.crossplay.desc":"Our servers have the Geyser crossplay software built-in<sup><a href='#footnotes' class='hover:link'>2</a></sup>, which allows Bedrock Edition players to join. Almost all plugins will work for Bedrock players as well.",
    "main.performance.title": "Insane performance.",
    "main.performance.desc": "Our servers are powered by AMD Ryzen™ 7 5700X processors<sup><a href='#footnotes' class='hover:link'>3</a></sup>, and around 4GB of RAM per server, which is twice as much as the leading competitor<sup><a href='#footnotes' class='hover:link'>4</a></sup>'s cheapest plan.",
    "main.footnote1": "The discontinued legacy console (Xbox One, Xbox 360, PS4, PS3, PlayStation Vita, Wii U, and New Nintendo 3DS) and Raspberry PI editions are not supported.",
    "main.footnote2": "Modded plans do not include Geyser built-in as it will not work once mods are installed.",
    "main.footnote3": "Each server is allotted a minimum of one thread, and doesn't nesescarily have access to all eight cores of the processor.",
    "main.footnote4": "The leading competitor refers to Apex Minecraft Hosting, which starts at $7.49 for the first month, and $9.99/mo afterwards.",
    ...
    "main.interface.desc":
      "Casi todos los proveedores de alojamiento utilizan la misma interfaz Pterodactyl®. Sentimos que podríamos hacerlo mejor, así que comenzamos el proyecto <a href='/software' class='text-accent hover:link'>Arth Panel</a>, que reimagina la experiencia de alojamiento de Minecraft.",
    "main.crossplay.title": "Juega con amigos en cualquier edición.",
    "main.crossplay.desc":"Nuestros servidores tienen el software de juego cruzado Geyser integrado<sup><a href='#footnotes' class='hover:link'>2</a></sup>, que permite a los jugadores de Bedrock Edition unirse. Casi todos los complementos también funcionarán para los jugadores de Bedrock.",
    "main.performance.title": "Rendimiento increíble.",
    "main.performance.desc": "Nuestros servidores están alimentados por procesadores AMD Ryzen™ 7 5700X<sup><a href='#footnotes' class='hover:link'>3</a></sup>, y alrededor de 4GB de RAM por servidor, que es el doble que el plan más barato del competidor líder<sup><a href='#footnotes' class='hover:link'>4</a></sup>.",
    "main.footnote1": "No se admiten las consolas heredadas discontinuadas (Xbox One, Xbox 360, PS4, PS3, PlayStation Vita, Wii U y New Nintendo 3DS) y las ediciones Raspberry PI.",
    "main.footnote2": "Los planes con mods no incluyen Geyser integrado ya que no funcionará una vez que se instalen los mods.",
    "main.footnote3": "A cada servidor se le asigna un mínimo de un thread, y no necesariamente tiene acceso a los ocho núcleos del procesador.",
    "main.footnote4": "El competidor líder se refiere a Apex Minecraft Hosting, que comienza en $7.49 por el primer mes, y $9.99/mes después.",
