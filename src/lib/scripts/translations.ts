export default {
  "en-US": {
    ...
    "main.footnote4": "The leading competitor refers to Apex Minecraft Hosting, which starts at $5.99 for the first month, and $7.99/mo afterwards.",
    ...
    "main.footnote4": "El competidor líder se refiere a Apex Minecraft Hosting, que comienza en $5.99 por el primer mes, y $7.99/mes después.",
