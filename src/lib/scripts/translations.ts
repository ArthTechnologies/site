export default {
  "en-US": {
    ...
    "main.footnote3": "Each server is allotted one core, and doesn't have access to all eight cores of the processor, because Minecraft can only utilize one core.",
    ...
    "main.footnote3": "A cada servidor se le asigna un núcleo y no tiene acceso a los ocho núcleos del procesador, porque Minecraft solo puede utilizar un núcleo.",
