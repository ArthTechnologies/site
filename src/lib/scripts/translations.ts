export default {
  "en-US": {
    ...
    "main.footnote3": "The discontinued legacy console (Xbox One, Xbox 360, PS4, PS3, PlayStation Vita, Wii U, and New Nintendo 3DS) and Raspberry PI editions are not supported.",
    ...
    "main.footnote2": "Los planes modded no incluyen Geyser™ integrado ya que no funciona con mods instalados.",
