export default {
  "en-US": {
    ...
    "modal.masto.title": "Compartir en mastodon",
    "modal.masto.desc": "Mastodon es una red social descentralizada, lo que significa que hay diferentes instancias o \"servidores\" a las que puedes unirte. Ingrese el nombre de su instancia a continuación:",
    "status.title": "Estado",
