export default {
  "en-US": {
    ...
    "main.footnote3": "Each server is allotted a minimum of one core, and doesn't nesescarily have access to all eight cores of the processor.",
    ...
    "main.footnote3": "A cada servidor se le asigna un mínimo de un núcleo, y no necesariamente tiene acceso a los ocho núcleos del procesador.",
